...
export default function MedicalHistoryPage() {
  ...
  const loadHistories = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await patientApi.getMedicalHistories(user.id, statusFilter || undefined);
  ...
  const handleDelete = async (historyId: number) => {
    ...
    try {
      const response = await patientApi.deleteMedicalHistory(user.id, historyId);
      if (response.success) {
