...
public class PrescriptionController {
    ...
    @ApiResponse(responseCode = "200", description = "Prescription found")
    @ApiResponse(responseCode = "404", description = "No prescription found for this appointment")
    public ResponseEntity<PrescriptionResponse> getByAppointmentId(@PathVariable UUID appointmentId) {
        PrescriptionResponse prescription = prescriptionService.getByAppointmentId(appointmentId);
